...
| M-05: Agent distribution | Server-free onboarding guide, portable Agent Skills instructions, Codex metadata, and GitHub/npm installation paths | Done locally for the `0.1.1` candidate | CI-10 and V-23; public npm skill availability follows registry publication |
...
| v0.1.1 | Documentation patch with the agent guide and host-neutral Codex/Claude Code skill packaged beside the CLI/API | CI-09 and CI-10 local/hosted checks pass; publish the artifact before advertising npm-hosted skill availability |
...
`agent-change-impact@0.1.1`; those gates also establish npm-hosted skill
availability. Future releases must repeat the same evidence stages.
