...
on Node.js `23.10.0` / macOS `Darwin 25.6.0 arm64` passes 34 smoke/integration
...
| Command | Result |
| --- | --- |
| `npm test` | Pass: 34 tests; build plus Node test runner |
