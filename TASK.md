...
| `npm run release:check` | Pass: package/lockfile version, changelog heading, entry points, and 38-file dry-run tarball set agree; `AGENT_IMPACT_RELEASE_TAG=v0.1.0 npm run release:check` also passes |
