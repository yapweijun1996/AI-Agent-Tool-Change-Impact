...
Date: 2026-09-07
Benchmark implementation revision: `d5f75d5`; latest Windows short-path boundary
fix: `0b72a83`; latest package verification revision: `d5f75d5`; latest provider
...
34096243103 passes the tested Node 22/24 Ubuntu/macOS/Windows matrix after the
